...
(* OASIS_START *)
(* DO NOT EDIT (digest: f580284311fdaa32bf2efbc95510a050) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "OCaml mini-framework using Mongrel2";
          description = None;
          categories = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "xbreed.ml"; })
            ];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\192Uom\216\215\252\127\"\228\025\005L\129\233\164";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
